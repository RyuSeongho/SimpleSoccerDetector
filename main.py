...
def process_video(video_path, team1_color_rgb, team2_color_rgb, tracker_debug_mode=False):
    ...
    tracker_manager = PlayerTrackerManager(frame_width, frame_height, dominant_colors[0])
...
if __name__ == "__main__":
    ...
    process_video(args.video_path, args.team1_color, args.team2_color, args.tracker_debug)
